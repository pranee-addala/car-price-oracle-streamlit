      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5">
          <Card className="shadow-lg bg-white h-full">
            <CardHeader className="bg-car-secondary text-white rounded-t-lg">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Car className="h-4 w-4 text-car-accent" />
                    <h3 className="text-sm font-medium">Car Brand</h3>
                  </div>
                  <Select 
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Calendar className="h-4 w-4 text-car-accent" />
                      <h3 className="text-sm font-medium">Year</h3>
                    </div>
                    <span className="text-sm font-semibold">{formData.year}</span>
                  </div>
                  <Slider
                    value={[formData.year]}
                    min={1994}
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Activity className="h-4 w-4 text-car-accent" />
                      <h3 className="text-sm font-medium">Distance Driven</h3>
                    </div>
                    <span className="text-sm font-semibold">{formatKilometers(formData.kmDriven)}</span>
                  </div>
                  <Slider
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Fuel className="h-4 w-4 text-car-accent" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <User className="h-4 w-4 text-car-accent" />
                    <h3 className="text-sm font-medium">Seller Type</h3>
                  </div>
                  <Select 
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Cog className="h-4 w-4 text-car-accent" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Users className="h-4 w-4 text-car-accent" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Gauge className="h-4 w-4 text-car-accent" />
                      <h3 className="text-sm font-medium">Mileage (km/l)</h3>
                    </div>
                    <span className="text-sm font-semibold">{formData.mileage} km/l</span>
                  </div>
                  <Slider
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Cog className="h-4 w-4 text-car-accent" />
                      <h3 className="text-sm font-medium">Engine (CC)</h3>
                    </div>
                    <span className="text-sm font-semibold">{formData.engine} CC</span>
                  </div>
                  <Slider
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <BarChart className="h-4 w-4 text-car-accent" />
                      <h3 className="text-sm font-medium">Max Power (bhp)</h3>
                    </div>
                    <span className="text-sm font-semibold">{formData.maxPower} bhp</span>
                  </div>
                  <Slider
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold">{formData.seats}</span>
                  </div>
                  <Slider
                ...
                <div className="flex flex-col items-center justify-center h-full">
                  {isLoading ? (
                    <div className="flex flex-col items-center gap-3 py-6">
                      <div className="w-16 h-16 border-4 border-car-light border-t-car-accent rounded-full animate-spin" />
                      <p className="text-car-muted">Calculating your car's value...</p>
                    </div>
                  ) : predictedPrice ? (
                    <div className="text-center space-y-4 py-6">
                      <p className="text-car-muted">Estimated Price:</p>
                      <div className="text-3xl font-bold text-car-primary">
                        {formatCurrency(predictedPrice)}
                      </div>
                      <div className="border border-car-light rounded-lg p-4 bg-car-light/30 mt-4">
                    ...
                    <div className="flex flex-col items-center gap-4 py-6 text-center">
                      <Car className="w-12 h-12 text-car-muted opacity-30" />
                      <div>
                        <h3 className="font-medium text-lg">No Prediction Yet</h3>
